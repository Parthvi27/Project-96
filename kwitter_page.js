...
like_button="<button class='btn btn-warning'"+firebase_message_id+" value="+like+" onclick='updatelikes(this.id)'>"
spanwithtag="<span class='glyphicon glyphicon-thumbs-up'>like:"+like+"</span></button><h3>";
row=name_withtag+message_with_tag+like_button+spanwithtag;
...
function updatelikes(message_id){
    ...
    firebase.database().ref(room_name),child(message_id).update_likes({
          like:update_likes
    })
}
function logout(){
